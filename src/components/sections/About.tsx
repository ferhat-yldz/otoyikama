...
export function About() {
    const features = [
        ...
        },
        {
            ...
            description: 'Müşteri memnuniyetini en üst düzeyde tutmayı garanti ediyoruz.',
        },
    ];

    return (
        <section className="section bg-black overflow-hidden" id="hakkimizda">
                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    <div className="w-full">
                        <ScrollAnimation animation="fade-right" duration={0.8}>
                            ...
                            <div className="mb-6 leading-relaxed text-[var(--color-text-secondary)]">
                                <TextReveal
                                    text={`${SITE_CONFIG.name}, yılların deneyimiyle ${SITE_CONFIG.contact.city}'da araç sahiplerine profesyonel temizlik ve bakım hizmetleri sunmaktadır. Modern ekipmanlarımız ve uzman kadromuzla aracınızın her detayına özen gösteriyoruz.`}
                                />
                            </div>
                            <div className="mb-8 leading-relaxed text-[var(--color-text-secondary)]">
                                <TextReveal
                                    text="İç dış yıkamadan detaylı temizliğe, pasta ciladan seramik kaplamaya kadar geniş hizmet yelpazemizle aracınızı ilk günkü parlaklığına kavuşturuyoruz."
                                    delay={0.5}
                                />
                            </div>
                            ...
                            <div className="grid sm:grid-cols-2 gap-4">
                                {features.map((feature, index) => (
                                    <div
                                        key={index}
                                        className="flex items-start gap-3 p-4 rounded-xl bg-black border border-[var(--color-border)] hover:border-[var(--color-primary)]/30 transition-colors"
                                    >
